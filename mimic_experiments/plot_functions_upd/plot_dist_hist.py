...
def main():
    ...
    temp_df = pd.DataFrame({'Value': kl_data.flatten()})
    p = sns.kdeplot(data=temp_df, log_scale=False, fill=True, common_norm=False, linewidths=2, palette='viridis', legend=False)
    ...
    plt.tight_layout()
    save_name = save_dir + "hists_lis_sns"
