...
def get_kl_data(final_path, len_data):
    with open(final_path, 'rb') as file:
        final_dict = pickle.load(file)
    kl_data = np.array(final_dict["kl"])[0]
    len_data = len(kl_data)
    len_data = kl_data.shape[0]
    idx = np.array(final_dict["idx"])[0]
...
def main():
    ...
    path_str1 = "/vol/aimspace/users/kaiserj/Individual_Privacy_Accounting/results_torch_upd2_after_workshop/kl_jax_torch_1000_remove_25000_dataset_Imdbcompressed_model_Tinymodel_subset_25000_range_0_25000_corrupt_0.0_corrupt_data_0.2_0_torch.pkl"
    path_str2 = "/vol/aimspace/users/kaiserj/Individual_Privacy_Accounting/results_torch_upd2_after_workshop/kl_jax_torch_1000_remove_25000_dataset_Imdbcompressed_model_Tinymodel_subset_25000_range_0_25000_corrupt_0.0_corrupt_data_0.2_0_torch.pkl"

    # path_str1 = "/vol/aimspace/users/kaiserj/Individual_Privacy_Accounting/results_torch_upd2_after_workshop/kl_jax_torch_1000_remove_25000_dataset_Imdbcompressed_model_Tinymodel_subset_25000_range_0_25000_corrupt_0.0_corrupt_data_0.1_label_corruption_0_torch.pkl"
    # path_str2 = "/vol/aimspace/users/kaiserj/Individual_Privacy_Accounting/results_torch_upd2_after_workshop/kl_jax_torch_1000_remove_25000_dataset_Imdbcompressed_model_Tinymodel_subset_25000_range_0_25000_corrupt_0.0_corrupt_data_0.2_label_corruption_0_torch.pkl"
    ...
    corrupt_kl1, non_corrupt_kl1 = get_kl_data(path_str1, len_data=25000)
    corrupt_kl2, non_corrupt_kl2 = get_kl_data(path_str2, len_data=25000)

    # Prepare data for the first plot
    kl_data1 = [corrupt_kl1, non_corrupt_kl1]
    label_list = ["Corrupted Data \n(Lorem)", "Uncorrupted Data"]

    # label_list = ["Corrupted Labels \n(Random)", "Uncorrupted Labels"]
    ...
    axs[0].set_title('IMDb - 20% Lorem Impsum') # , fontsize=8)
    ...
    axs[1].set_title('IMDb - 20% Lorem Impsum') # , fontsize=8)
    ...
    plt.tight_layout()
    save_name = save_dir + "new_corruption_both_text_lorem"
