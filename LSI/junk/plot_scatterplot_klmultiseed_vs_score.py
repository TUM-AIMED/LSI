...
def main():
    kl_path = "/vol/aimspace/users/kaiserj/Individual_Privacy_Accounting/results_kl_indiv_script/results_diag_backpackef_150_30/results_all.pkl"
    feld_path = "/vol/aimspace/users/kaiserj/Individual_Privacy_Accounting/Feld_Score/cifar100_infl_matrix.npz"

    kl_data, kl_all, kl_std, idx = get_kl_data(kl_path, "kl2")
    images, label = get_images_form_idx(idx)

    feld_scores = get_feld_scores(feld_path, idx)
    file_name = "z_kl2multiseed_backpackef_vs_feld"
