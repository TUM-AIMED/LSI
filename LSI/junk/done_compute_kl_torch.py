...
if __name__ == "__main__":
    ...
    parser.add_argument("--range2", type=int, default=50000, help="Value for lerining_rate (optional)")
    ...
    if args.name == None and args.range1 == 0 and args.range2 == 0:
        file_name = "kl_jax_torch_" + str(args.epochs) + "_remove_" + str(args.n_rem) + "_dataset_" + str(args.dataset)  + "_model_" + str(args.model) + "_laptype" + str(args.laptype) + "_subset_" + str(args.subset) + "_corrupt_" + str(args.corrupt)  + "_corrupt_data_" + str(args.corrupt_data) + "_" + str(args.corrupt_data_label) + "_" + str(args.name_ext)
    if args.name == None and args.range1 != 0 or args.range2 != 0:
        file_name = "kl_jax_torch_" + str(args.epochs) + "_remove_" + str(args.n_rem) + "_dataset_" + str(args.dataset)  + "_model_" + str(args.model) + "_laptype" + str(args.laptype) + "_subset_" + str(args.subset) + "_range_" + str(args.range1) + "_" + str(args.range2) + "_corrupt_" + str(args.corrupt) + "_corrupt_data_" + str(args.corrupt_data) + "_" + str(args.corrupt_data_label) + "_" + str(args.name_ext)
    else:
        file_name = args.name
