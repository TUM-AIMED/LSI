...
def train_with_params(
    ...
    scheduler = torch.optim.lr_scheduler.MultiStepLR(optimizer, [150, 250, 350, 450], gamma=0.5)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--n_rem", type=int, default=50, help="Value for lerining_rate (optional)")
    parser.add_argument("--n_seeds", type=int, default=10, help="Value for lerining_rate (optional)")
    parser.add_argument("--name", type=str, default="mnist_logreg4500_10_50_noisy_matchingkl_50epochs", help="Value for lerining_rate (optional)")
    ...
    params["model"]["model"] = "logreg"
    params["model"]["dataset_name"] = "mnist"
    params["model"]["name_base"] = "logreg_mnist_"
    params["model"]["name"] = "logreg_mnist_"
    params["model"]["name"] = params["model"]["name_base"] + str(try_num)
    params["training"] = {}
    params["training"]["batch_size"] = 256
    params["training"]["num_epochs_init"] = 3000
    params["training"]["l2_regularizer"] = 0
    params["testing"] = {}
    ...
    # data_set._set_classes([4, 9])
    # data_set_test._set_classes([4, 9])

    keep_indices = [*range(4500)]
    ...
    for seed in tqdm(range(N_SEEDS)):
        ...
        for rem_idx in range(N_REMOVE):
            ...
            if "kron" in representation:
                ...
                kl1_1, kl2_1, mean_diff_s, mean_diff_m = computeKL(DEVICE, backend_class, "kron", model_rem, model_all, train_loader_0, train_loader_0, params["training"]["l2_regularizer"]) 
            ...
            if "diag" in representation:
                ...
                kl1_2, kl2_2, mean_diff_s, mean_diff_m = computeKL(DEVICE, backend_class, "diag", model_rem, model_all, train_loader_0, train_loader_0, params["training"]["l2_regularizer"]) 
            ...
            if "full" in representation:
                ...
                kl1_3, kl2_3, mean_diff_s, mean_diff_m = computeKL(DEVICE, backend_class, "full", model_rem, model_all, train_loader_0, train_loader_0, params["training"]["l2_regularizer"]) 
