...
from LSI.experiments.Riemann_LSI.functorch_utils import get_params_structure, stack_gradient, custum_hvp, stack_gradient2, stack_gradient3
    ...
    def CE_loss(self, param, data):
        ...
        if self.type == "fc":
            if self.factor is not None:
                ...
                return criterion(y_pred, y.long())
        else:
            if self.factor is not None:
